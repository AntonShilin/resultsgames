  ...
  render() {
    return (
      <div className="container-xl pt-5">
        {this.props
          .matchday(this.props.allfootball!, "SPAIN")
...
const leagueSpain = SortLeagueByName(withConvertDateMethod);
export default connect(mapStateToProps, mapDispatchToProps)(leagueSpain);
