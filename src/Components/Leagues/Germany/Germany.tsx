  ...
  render() {
    return (
      <div className="container-xl pt-5">
        {this.props
          .matchday(this.props.allfootball!, "GERMANY")
...
const leagueGerman = SortLeagueByName(withConvertDateMethod);
export default connect(mapStateToProps, mapDispatchToProps)(leagueGerman);
