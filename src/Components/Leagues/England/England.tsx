  ...
  render() {
    return (
      <div className="container-xl pt-5">
        {this.props
          .matchday(this.props.allfootball!, "ENGLAND")
...
const leagueEngland = SortLeagueByName(withConvertDateMethod);
export default connect(mapStateToProps, mapDispatchToProps)(leagueEngland);
